...
fun starterLearningActivitiesFor(languageCode: String): List<LearningActivity> =
    starterLearningActivities.filter { it.id.startsWith("$languageCode-") } +
        ...
        a1GratitudeActivitiesFor(languageCode) +
        a1FarewellActivitiesFor(languageCode) +
        ...
        a1PreferenceReadingActivitiesFor(languageCode) +
        a1BasicQuestionActivitiesFor(languageCode) +
        a1ResidenceQuestionActivitiesFor(languageCode) +
        ...
        a1FamilyIdentificationActivitiesFor(languageCode) +
