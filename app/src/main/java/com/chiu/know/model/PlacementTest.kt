...
val starterKoreanPlacementQuestions = listOf(
    PlacementQuestion("ko-a1-001", CefrLevel.A1, "저는 학생___.", listOf("입니다", "이 있어요", "을 해요", "에 가요"), 0),
    PlacementQuestion("ko-a1-002", CefrLevel.A1, "저는 브라질 사람___.", listOf("입니다", "이 있어요", "을 만나요", "에 가요"), 0),
    PlacementQuestion("ko-a2-001", CefrLevel.A2, "어제 친구를 ___.", listOf("만나요", "만났어요", "만날 거예요", "만나고 있어요"), 1),
    PlacementQuestion("ko-a2-002", CefrLevel.A2, "지금 비가 오니까 우산을 ___.", listOf("가져가세요", "두고 가세요", "버리세요", "잃어버리세요"), 0),
    PlacementQuestion("ko-b1-001", CefrLevel.B1, "시간이 있으면 같이 영화를 ___.", listOf("봤어요", "봐요", "봤었어요", "보지 않았어요"), 1),
    PlacementQuestion("ko-b1-002", CefrLevel.B1, "한국에 가게 되면 한복을 꼭 ___.", listOf("입어 보고 싶어요", "입어 본 적이 있어요", "입고 있었어요", "입지 않았어요"), 0),
    ...
    PlacementQuestion("ko-c1-001", CefrLevel.C1, "비가 많이 ___ 경기는 계속되었다.", listOf("왔지만", "오는 바람에", "왔으므로", "오자마자"), 0),
    ...
    PlacementQuestion("ko-c2-002", CefrLevel.C2, "그 표현은 여러 해석의 여지를 남기도록 의도적으로 ___ 작성되었다.", listOf("모호하게", "명료하게", "단정적으로", "구체적으로"), 0)
)
